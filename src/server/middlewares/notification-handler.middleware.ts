...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'user.create': { roles: ['chef'], key: 'chef-invitation', tenantPath: ['restaurant', 'user'], userPath: [] },
  'reservation.create': {
    roles: ['owner'],
  ...
  'menu.update': { roles: ['guest'], key: 'menu-update', tenantPath: ['restaurant', 'menu'], userPath: [] },
};
